...
system(paste0(PLINKpath,"/plink --bed SNP_AllChrom_AllInd_dp7_gq9_bi.bed --bim SNP_AllInd_unfilt_chrfix.bim --fam SNP_AllChrom_AllInd_dp7_gq9_bi.fam --make-bed --out SNP_AllChrom_AllInd_dp7_gq9_bi_chrfix"))

###give snp ids -- labels every snp with a unique code
system(paste0(PLINKpath,"/plink2 --bfile SNP_AllChrom_AllInd_dp7_gq9_bi_chrfix --chr-set 17 --set-all-var-ids @_# --new-id-max-allele-len 20 --make-bed --out SNP_AllChrom_AllInd_dp7_gq9_bi_chrfix_uniqueID"))
...
system(paste0(PLINKpath,"/plink --bfile wild_standard_final --keep ../inputs/ranch_subset_vcftools.txt --chr-set 17 --make-bed --out ranch_standard_postsubset"))#ranch
system(paste0(PLINKpath, "/plink --bfile wild_standard_final --remove ../inputs/ranch_subset_vcftools.txt --chr-set 17 --make-bed --out refuge_standard_postsubset")) #refuge

#export subset files
system(paste0(PLINKpath,"/plink2 --bfile ranch_standard_postsubset --chr-set 17 --export vcf-4.2 bgz --out ranch_standard_postsubset"))
system(paste0(PLINKpath,"/plink2 --bfile refuge_standard_postsubset --chr-set 17 --export vcf-4.2 bgz --out refuge_standard_postsubset"))

####additional filtering for select analyses####
#Create directory for files with extra filtering
dir.create("./addtl_filter")
...
system(paste0(PLINKpath,"/plink --bfile ../SNP_wild_dp7_gq9_bi --chr-set 17 --keep-allele-order --geno 0.1 --hwe 1e-6 --make-bed --out wild_kin_roh_filter"))
